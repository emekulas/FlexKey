...
// ========================================
#define MAX_GROUPS          5
#define MAX_UIDS            200  // Total UID limit (can be reduced to 75 if needed)
#define MAX_URLS_PER_GROUP  15
#define MAX_URL_LENGTH      256  // Per URL
...
struct Group_t {
    String name;
    bool active;
    UID_t uids[MAX_UIDS];  // All UIDs in this group
    uint16_t uidCount;
    ...
    uint16_t relayPulseDuration;  // milliseconds (if pulse mode)
...
struct WiFiConfig_t {
    ...
    // AP Mode Control
    bool apModeEnabled;  // Can be disabled if WiFi SSID is configured
